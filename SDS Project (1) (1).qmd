...
-   The intercept is the estimated gestation time in days when all of the predictors are at their baseline levels, which includes the variable 'never smoked'. The estimated gestation time is 262.318 days.
...
-   For every one-unit increase in the "once did, not now" smoking category, gestation time decreases by 0.943 days on average. This variable is categorical.

-   For every one-unit increase in the "until current pregnancy" smoking category, gestation time decreases by 0.441 days on average. This variable is categorical.
...
-   For every one-unit increase in the "now" smoking category, gestation time is multiplied by 1.003 on average, based on the exponentiated coefficient from the model's log transformation. This variable is categorical.

-   For every one-unit increase in the "once did, not now" smoking category, gestation time is multiplied by 1.003 on average, based on the exponentiated coefficient from the model's log transformation. This variable is categorical.

-   For every one-unit increase in the "until current pregnancy" smoking category, gestation time is multiplied by 1.000 on average, based on the exponentiated coefficient from the model's log transformation. This variable is categorical.
